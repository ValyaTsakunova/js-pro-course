    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            data = _context.sent;
            (0, _script.showNotification)(data);
            _context.next = 14;
            break;
...
},{"./script.js":6,"@babel/runtime/helpers/asyncToGenerator":2,"@babel/runtime/helpers/interopRequireDefault":3,"@babel/runtime/regenerator":4}],2:[function(require,module,exports){
...
function showNotification(data) {
  var isNotificationDisabled = localStorage.getItem('isNotificationDisabled') || false;
  var currentNotificationID = localStorage.getItem('currentNotificationID') || 1;

  if (isNotificationDisabled) {
    return;
  }

  var currentNotification = data.find(function (el) {
    return el.id == currentNotificationID;
  });
  var notificationWrapper = document.createElement('div');
  notificationWrapper.innerHTML = "\n        <section class=\"popUp\">\n            <div class=\"notification\">\n                <div class=\"title\"></div>\n                <div class=\"text\"></div>\n            </div>\n            <div>\n            <button class=\"close\">\n            </button>\n            </div>\n            <div class=\"disableNot\">\n                <input type=\"checkbox\" class=\"disable\" tabindex=\"1\"> Disable\n            </div> \n            <div class=\"pagination\">\n                <button class=\"leftBtn\"></button>\n                    <div class=\"paginationButtons\">\n                    ".concat(data.map(function (notification) {
    return "\n                    <input type=\"radio\" \n                    name=\"radioButton\"\n                    tabindex=\"3\"\n                    id=\"".concat(notification.id, "\"  \n                    checked=\"").concat(notification.id == currentNotificationID, "\">\n                    </input>");
...
function addNotificationText(currentNotification) {
  ...
  var phraseBlock = document.querySelector('.text');
  titleBlock.innerHTML = "".concat(currentNotification.id, ". ").concat(currentNotification.title);
...
function setEventListeners(data, currentNotificationID) {
  ...
  leftBtn.addEventListener('click', function () {
    ...
    addNotificationText(data.find(function (el) {
      return el.id == currentNotificationID;
    }));
  ...
  var radioBtn = document.querySelector('.paginationButtons');
